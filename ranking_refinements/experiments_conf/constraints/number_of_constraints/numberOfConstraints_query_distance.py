...
EXPERIMENTS = [
    {
        "name": "NumberOfConstraints_QD_Law",
    ...
    {
        "name": "NumberOfConstraints_QD_Astronauts",
        "dataset": "astronauts",
    ...
    {
        "name": "NumberOfConstraints_QD_MEPS",
        "dataset": "MEPS",
    ...
    {
        "name": "NumberOfConstraints_QD_TPCH",
        "dataset": "TPC-H",
...
if __name__ == '__main__':
    ...
    runner = ExperimentsRunner(exprs, Path("experiments", 'number_of_constraints', 'query_distance'),
