...
EXPERIMENTS = [
    {
        ...
        "max_deviations": [0.5],
        "useful_methods": [UsefulMethod.MAX_ORIGINAL],
        "algorithms": [RefinementMethod.MILP_OPT],
        "k_list": [10],
    },
    {
        "name": "ConstraintsBounds_MO_Astronauts",
        "dataset": "astronauts",
    ...
    {
        "name": "ConstraintsBounds_MO_MEPS",
        "dataset": "MEPS",
    ...
    {
        "name": "ConstraintsBounds_MO_TPCH",
        "dataset": "TPC-H",
...
if __name__ == '__main__':
    ...
    runner = ExperimentsRunner(exprs, Path("experiments", 'constraints_bounds', 'max_original'),
