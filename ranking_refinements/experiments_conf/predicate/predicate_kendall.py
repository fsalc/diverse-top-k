...
if __name__ == '__main__':
    ...
    runner = ExperimentsRunner(exprs, Path("experiments", 'Predicate', 'kendall'), [("duration[sec]", "K"), ("deviation", "K")],
                               iterations=5)
    runner.run()
