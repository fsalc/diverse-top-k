...
if __name__ == '__main__':
    ...
    runner = ExperimentsRunner(exprs, Path("experiments", 'Predicate', 'max_original'), [("duration[sec]", "K"), ("deviation", "K")],
                               iterations=5)
    runner.run()
